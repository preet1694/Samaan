...
export const SearchCarrier = () => {
  ...
  // Fetch prices when carriers update
  useEffect(() => {
        ...
        await Promise.all(
          carriers.map(async (carrier) => {
            try {
              ...
              console.error(
                "Price calculation failed for carrier:",
                carrier.id
              );
  ...
  const handleSelectCarrier = async (trip) => {
    if (!senderEmail) {
      alert("Please log in as a sender to select a carrier.");
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <button
            ...
            className="w-full md:w-auto mt-4 bg-indigo-600 text-white px-4 py-2 rounded-md flex items-center"
          >
            ...
            <div key={carrier.id} className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">
                    End Landmark : {capitalizeFirstLetter(carrier.endLandmark)}
                  </p>
                  <p className="text-sm text-gray-500">
                ...
                {(userRole === "sender" && (
                  <button
                    ...
                    className="mt-4 bg-indigo-600 text-white px-4 py-2 rounded-md flex items-center"
                  >
